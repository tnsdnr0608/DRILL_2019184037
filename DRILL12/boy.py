from pico2d import *
import gameworld
import play_state # ball 객체 가져옴
from ball import Ball #볼 파일로부터, BALL 클래스 확보

#1 : 이벤트 정의
RD, LD, RU, LU, TIMER, SPACE = range(6)
event_name = ['RD', 'LD', 'LU', 'TIMER', 'SPACE'] #이벤트 숫자로부터 받는다.
